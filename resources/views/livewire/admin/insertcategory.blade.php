<div class="container mt-5">
    <div class="card">
        ...
        <div class="">
            <form method="POST" action="{{ route('Insertproduct') }}" enctype="multipart/form-data" id="productForm" class="needs-validation"  novalidate>
                @csrf
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body row">
                            ...
                            <div class="mb-3 col-6">
                                ...
                                <input type="file" class="form-control" id="images" name="multipleimage[]" accept="image/*"
                                    multiple>
...
<div class="col-md-3 col-4">
    ...
    <div class="col-md-3">
        ...
        <input type="number" class="form-control" id="final_price" name="final_price"
            placeholder="Final price" required readonly>
                        ...
                        <div class="card-body">
                            <div id="featuresWrapper">
                                <div class="row g-2 mb-2 feature-row">
                                    <!-- Key -->
                                    <div class="col-md-5">
                                        <input type="text" class="form-control" name="feature_keys[]"
                                            placeholder="Enter Key (e.g. Color)">
                                    </div>
                                    <!-- Value -->
                                    <div class="col-md-5">
                                        <input type="text" class="form-control" name="feature_values[]"
                            ...
                            <!-- Add Feature Button -->
                            <button type="button" class="btn btn-outline-primary btn-sm" id="addFeature">+ Add
                                Feature</button>
        ...
        if (multiInput.files) {
            [...multiInput.files].forEach((file) => {
                ...
                reader.onload = (e) => {
                    ...
                    btn.innerHTML = "×";
                    btn.type = "button";
                    btn.classList.add("btn", "btn-sm", "btn-danger", "position-absolute", "top-0",
                        "end-0");
